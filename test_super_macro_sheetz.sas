...
CLASS sheetz_usage / PRELOADFMT;
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (dda='Checking' mms='Mon Mkt' sav='Savings' tda='Time Dep' ira='IRA' mtg='Mortgage' heq='Home Eq' card='Credit Card' iln='Dir Loan' ind='Ind Loan' sln='Student loan' sec='Securities'
...
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (dda_amt='Checking'*pctsum<dda>='Avg. Bal.' mms_amt='Mon Mkt'*pctsum<mms>='Avg. Bal.' sav_amt='Savings'*pctsum<sav>='Avg. Bal.' tda_amt='Time Dep'*pctsum<tda>='Avg. Bal.'
...
format sheetz_usage $sheetz. ;
run;
data temp_main;
set data.main_201303;
where dda eq 1;
keep hhid sheetz_usage hh;
run;
data temp_contr;
...
CLASS sheetz_usage / PRELOADFMT;
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (dda_con='Checking'*pctsum<hh>='Avg. Con.' mms_con='Mon Mkt'*pctsum<hh>='Avg. Con.' sav_con='Savings'*pctsum<hh>='Avg. Con.' tda_con='Time Dep'*pctsum<hh>='Avg. Con.' ira_con='IRA'*pctsum<hh>='Avg.
...
where dda eq 1;
var hh;
CLASS sheetz_usage segment band ixi_tot cbr distance tenure_yr tran_code/ PRELOADFMT;
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (segment)*N='HHs'*f=comma12. segment*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (tran_code='Tran. Segment')*N='HHs'*f=comma12. tran_code='Tran. Segment'*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (ixi_tot='Estimated Wealth')*N='HHs'*f=comma12. ixi_tot='Estimated Wealth'*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (cbr)*N='HHs'*f=comma12. cbr*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (distance='Dist to Branch')*N='HHs'*f=comma12. distance='Dist to Branch'*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (tenure_yr="tenure (Yrs)")*N='HHs'*f=comma12. tenure_yr="tenure (Yrs)"*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_usage All) All, sum='All'*hh='HHs'*f=comma12. (band='Profit Band')*N='HHs'*f=comma12. band='Profit Band'*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
format sheetz_usage $sheetz. ;
...
ods pdf file="C:\Documents and Settings\ewnym5s\My Documents\SAS\Sheetz_Profile_20130428.pdf" style=mtbnew nogfootnote dpi=300;
...
where prod not in ('HH','PAGE','TABLE','SDB','SLN','TRS','INS') and what = 'pctsum' and what2 eq '1' and proxy ne '';
...
proc sgplot data=penet1 ;
where prod not in ('HH','PAGE','TABLE','SDB','SLN','TRS','INS') and what2 = 'pctsum' and what eq 'amt' and proxy ne '';
...
where prod in ('TOTAL') and what2 = 'pctsum' and what eq 'contr' and proxy ne '';
vbar proxy / missing group=proxy groupdisplay=cluster response=col1 nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
proc sgplot data=contr1 ;
where prod not in ('HH','PAGE','TABLE','SDB','SLN','TRS','INS') and what2 = 'pctsum' and what eq 'con' and proxy ne '';
