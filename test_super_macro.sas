...
CLASS sheetz_grp / PRELOADFMT;
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (dda='Checking' mms='Mon Mkt' sav='Savings' tda='Time Dep' ira='IRA' mtg='Mortgage' heq='Home Eq' card='Credit Card' iln='Dir Loan' ind='Ind Loan' sln='Student loan' sec='Securities'
...
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (dda_amt='Checking'*pctsum<dda>='Avg. Bal.' mms_amt='Mon Mkt'*pctsum<mms>='Avg. Bal.' sav_amt='Savings'*pctsum<sav>='Avg. Bal.' tda_amt='Time Dep'*pctsum<tda>='Avg. Bal.'
...
format sheetz_grp $sheetz. ;
run;
data temp_main;
set data.main_201303;
where dda eq 1;
keep hhid sheetz_grp hh;
run;
data temp_contr;
...
CLASS sheetz_grp / PRELOADFMT;
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (dda_con='Checking'*pctsum<hh>='Avg. Con.' mms_con='Mon Mkt'*pctsum<hh>='Avg. Con.' sav_con='Savings'*pctsum<hh>='Avg. Con.' tda_con='Time Dep'*pctsum<hh>='Avg. Con.' ira_con='IRA'*pctsum<hh>='Avg.
...
where dda eq 1;
var hh;
CLASS sheetz_grp segment band ixi_tot cbr distance tenure_yr tran_code/ PRELOADFMT;
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (segment)*N='HHs'*f=comma12. segment*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (tran_code='Tran. Segment')*N='HHs'*f=comma12. tran_code='Tran. Segment'*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (ixi_tot='Estimated Wealth')*N='HHs'*f=comma12. ixi_tot='Estimated Wealth'*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (cbr)*N='HHs'*f=comma12. cbr*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (distance='Dist to Branch')*N='HHs'*f=comma12. distance='Dist to Branch'*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (tenure_yr="tenure (Yrs)")*N='HHs'*f=comma12. tenure_yr="tenure (Yrs)"*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
table (sheetz_grp All) All, sum='All'*hh='HHs'*f=comma12. (band='Profit Band')*N='HHs'*f=comma12. band='Profit Band'*rowPCTN="Percent"*f=pctfmt./ nocellmerge misstext ='0';
format sheetz_grp $sheetz. ;
...
set data.main_201303;
where dda eq 1;
keep sheetz_grp dda: mms: sav: tda: ira: mtg: iln: ind: heq: card: ccs: sec: hhid ;
...
balance = heq_amt;
output;
keep order balance sheetz_grp hhid;
run;
proc format;
...
data box1;
set box1;
variable = put(sheetz_grp,$sheetz.);
run;
proc sql;
...
set data.main_201303;
where dda eq 1;
keep sheetz_grp dda mms sav tda ira mtg iln ind heq card sec hhid ;
run;
data cbox;
...
output;
keep order contribution sheetz_grp hhid;
run;
proc format;
value order 1 = 'Checking' 2 = 'Money Mkt' 3 = 'Savings' 4 = 'Time Dep' 5 = 'IRAs' 6 = 'Credit Card' 7 = 'Dir. Loan' 8 = 'Ind. Loan' 9 = 'Securities' 10= 'Mortgage' 11='Home Equity';
run;
...
ods pdf file="C:\Documents and Settings\ewnym5s\My Documents\SAS\Sheetz_Profile_20130426.pdf" style=mtbnew nogfootnote dpi=300;
...
vbar prod / missing group=sheetz_grp groupdisplay=cluster response=col2 nostatlabel grouporder=data datalabel DATALABELATTRS=(family=Arial Size=6);
...
format prod $ptypeorder. sheetz_grp $sheetz. col2 percent4.;
run;
ODS PDF startpage=NO;
Title 'Average Balance';
proc sgplot data=penet1 ;
where prod not in ('HH','PAGE','TABLE','SDB','SLN','TRS','INS') and what2 = 'pctsum' and what eq 'amt';
vbar prod / missing group=sheetz_grp groupdisplay=cluster response=col3 nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
format prod $ptypeorder. sheetz_grp $sheetz. col3 dollar12.;
run;
title;
...
vbar sheetz_grp / missing group=sheetz_grp groupdisplay=cluster response=col1 nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
keylegend / TITLEATTRS=(Weight=Bold);
format prod $ptypeorder. sheetz_grp $sheetz. col1 dollar12.1;
run;
ODS PDF startpage=YES;
Title 'Average Contribution by Product';
proc sgplot data=contr1 ;
where prod not in ('HH','PAGE','TABLE','SDB','SLN','TRS','INS') and what2 = 'pctsum' and what eq 'con';
vbar prod / missing group=sheetz_grp groupdisplay=cluster response=col1 nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
xaxis label='Product' LABELATTRS=(Weight=Bold) tickvalueformat=DATA type=discrete discreteorder=data fitpolicy=stagger;
yaxis label='Average Contribution' LABELATTRS=(Weight=Bold) ;
keylegend / TITLEATTRS=(Weight=Bold);
format prod $ptypeorder. sheetz_grp $sheetz. col1 dollar12.1;
...
vbar segment / missing group=sheetz_grp groupdisplay=cluster response=pct nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
format sheetz_grp $sheetz. pct percent6.;
run;
proc sort data=segments1;
by tran_code proxy;
run;
...
vbar tran_code / missing group=sheetz_grp groupdisplay=cluster response=pct nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
vbar band / missing group=sheetz_grp groupdisplay=cluster response=pct nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
vbar ixi_tot / missing group=sheetz_grp groupdisplay=cluster response=pct nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
vbar distance / missing group=sheetz_grp groupdisplay=cluster response=pct nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
vbar tenure_yr / missing group=sheetz_grp groupdisplay=cluster response=pct nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
vbar cbr / missing group=sheetz_grp groupdisplay=cluster response=pct nostatlabel grouporder=data datalabel DATALABELATTRS=(Size=6);
...
proc tabulate data=data.main_201303 missing;
where dda eq 1;
class sheetz_grp;
var hh;
table sheetz_grp='Analysis Group' ALL='Total',N='HHs'*f=comma12. pctN='Percent'*f=pctfmt./ nocellmerge ;
format sheetz_grp $sheetz.;
run;
ods pdf close;
